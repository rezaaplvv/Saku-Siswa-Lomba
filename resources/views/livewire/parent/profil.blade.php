<div x-data="{ 
    ...
    <!-- Main Desktop & Mobile Responsive Grid Wrapper -->
    <div class="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6 relative z-10 font-['Outfit']">
        ...
        <div class="md:col-span-6 space-y-4">
            ...
            <!-- ======================================================== -->
            <div class="bg-white rounded-3xl p-6 shadow-xs border border-slate-100/80 space-y-5 relative z-10">
        <!-- Section Header -->
        <div class="flex items-center space-x-2 pb-1">
            ...
            <h4 class="text-[11px] font-extrabold text-slate-800 uppercase tracking-wider">Informasi Akun</h4>
        </div>

        <!-- Initials Avatar and Student Name with Edit Button -->
        <div class="flex items-center space-x-4 pb-4 border-b border-slate-100">
            <div class="relative shrink-0">
                <div class="w-16 h-16 rounded-full bg-slate-100 border border-amber-200/60 flex items-center justify-center overflow-hidden">
                    <img src="/assets/{{ $student->avatar ?? 'i1.png' }}" alt="Profile" class="w-full h-full object-cover rounded-full">
                </div>
                <!-- Dedicated Edit Profile Avatar Button Badge (Bottom Center) -->
                <button 
                    type="button" 
            ...
            <div>
                <h3 class="text-base font-bold text-slate-800 tracking-tight font-['Outfit']">{{ $student->name }}</h3>
                <span class="inline-flex px-2.5 py-0.5 mt-1 rounded-full text-[10px] font-bold bg-amber-50 text-amber-700 border border-amber-100 uppercase tracking-wider">
                    Wali Murid Siswa
                </span>
            </div>
        </div>
        ...
        <div class="space-y-4 pt-1">
            ...
            <div class="flex items-center justify-between py-1">
                <div class="flex items-center space-x-3">
                    <div class="w-8 h-8 rounded-full bg-amber-50 border border-amber-50 flex items-center justify-center text-amber-600">
                    ...
                    <span class="text-xs font-semibold text-slate-500">NISN Siswa</span>
                </div>
                <div class="flex items-center space-x-2">
                    <span class="text-xs font-bold text-slate-800">{{ $student->nisn }}</span>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between py-1">
                ...
                <div class="flex items-center space-x-2">
                    <span class="text-xs font-bold text-slate-800">{{ $student->class_name }}</span>
                </div>
            </div>

            <!-- Row 4: Tahun Ajaran (Dynamic) -->
            <div class="flex items-center justify-between py-1">
                <div class="flex items-center space-x-3">
                    <div class="w-8 h-8 rounded-full bg-amber-50 border border-amber-50 flex items-center justify-center text-amber-600">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div class="flex items-center space-x-2">
                    <span class="text-xs font-bold text-slate-800">{{ $academicYear }}</span>
                </div>
            </div>
        </div>
    </div>

    <!-- LOGOUT ACTION CARD (Placed on left column below Informasi Akun, matching teacher style) -->
            <div class="bg-white border border-slate-100 rounded-3xl p-5 shadow-xs relative z-10">
        ...
        <!-- Right Column (Desktop: 6 Cols) -->
        <div class="md:col-span-6 space-y-4">
            <!-- ======================================================== -->
            <!-- CARD 2: PENGATURAN KEAMANAN                             -->
            <!-- ======================================================== -->
            <div class="bg-white rounded-3xl p-6 shadow-xs border border-slate-100/80 space-y-4 relative z-10">
        <!-- Section Header -->
        <div class="flex items-center space-x-2 pb-1">
            <div class="w-6 h-6 rounded-lg bg-amber-50 border border-amber-100 flex items-center justify-center text-amber-600 shrink-0">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
            ...
            <h4 class="text-[11px] font-extrabold text-slate-800 uppercase tracking-wider">Pengaturan Keamanan</h4>
        </div>
        ...
        <div class="space-y-3">
            ...
            <button type="button" 
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-slate-400 font-medium mt-0.5">Perbarui password untuk keamanan akun</p>
                    </div>
                </div>
            ...
            <!-- Reset PIN Button (Triggers Modal) -->
            <button type="button" 
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h5 class="text-xs font-bold text-slate-800">Ubah PIN Transaksi</h5>
                        <p class="text-[10px] text-slate-400 font-medium mt-0.5">Atur ulang PIN transaksi Anda</p>
                    </div>
                </div>
                <svg class="w-4 h-4 text-slate-400 shrink-0" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
    ...
    <!-- ======================================================== -->
    <!-- CARD 3: HUBUNGI SEKOLAH (White/Cream theme pop-up)       -->
    <!-- ======================================================== -->
    <div class="bg-white border border-slate-100 rounded-3xl p-6 shadow-xs text-slate-800 relative z-10 overflow-hidden flex flex-col justify-between min-h-[175px]">
        ...
        <a href="https://wa.me/6285782257192?text=Halo%20Admin%20SakuSiswa%2C%20saya%20wali%20murid%20dari%20{{ urlencode($student->name) }}%20(NISN%3A%20{{ urlencode($student->nisn) }})%20Kelas%20{{ urlencode($student->class_name) }}%20ingin%20meminta%20informasi%20bantuan%20seputar%20tabungan." 
           target="_blank" 
           class="flex w-full justify-between items-center py-3 px-4 bg-[#25D366] hover:bg-[#e5bf43] text-slate-900 font-extrabold rounded-2xl transition-all shadow-xs cursor-pointer z-10 mt-auto">
            <div class="flex items-center space-x-2">
                <!-- WhatsApp SVG icon -->
