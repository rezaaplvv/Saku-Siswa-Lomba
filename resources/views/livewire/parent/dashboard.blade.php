<div wire:poll.25s x-data="{ showModal: false, showBalance: true }" @close-modal.window="showModal = false" class="-mx-4 -mt-4 sm:-mx-6 sm:-mt-6 md:-mx-8 md:-mt-8 p-4 sm:p-6 md:p-8 min-h-screen bg-[#ffd554] pb-28 md:pb-12 space-y-5 font-sans relative overflow-hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6 relative z-10">
        
        <!-- Left Column (Desktop: 7 Cols) -->
        <div class="md:col-span-7 space-y-5">
            <!-- ======================================================== -->
            <!-- TOP SECTION: Balance Card (Premium Dark Metal Credit Card)-->
            <!-- ======================================================== -->
    ...
    <!-- ======================================================== -->
    <!-- VARIATION 1: Deposits vs Withdrawals (Pastel Tinted Cards)-->
    <!-- ======================================================== -->
    <div class="grid grid-cols-2 gap-4">
        <!-- Deposits Stats Card (Pastel Green bg) -->
        ...
        <!-- Withdrawals Stats Card (Pastel Rose bg) -->
    ...
    <div class="bg-white border border-slate-100 rounded-3xl p-6 shadow-xs relative z-10">
        ...
        <div class="md:col-span-5 space-y-5">
            <!-- ======================================================== -->
            <!-- VARIATION 3: Savings Target (Gradient Mint bg)           -->
            <!-- ======================================================== -->
            @php
        ...
        <!-- Editable inline target input form -->
        @if($is_editing_target)
            <div class="mb-4 p-3 bg-white/80 border border-amber-100 rounded-xl space-y-2">
                ...
                @error('new_target') <span class="text-[11px] text-rose-500 font-semibold block">{{ $message }}</span> @enderror
            </div>
        @endif
    ...
    <!-- ======================================================== -->
    <!-- VARIATION 4: Transactions List (Grouped inside single card)-->
    <!-- ======================================================== -->
    <div class="space-y-3">
    ...
    <!-- ======================================================== -->
    <!-- VARIATION 5: Parenting Financial Tips (Solid Cream Card) -->
    <!-- ======================================================== -->
