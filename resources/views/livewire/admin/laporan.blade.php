<div class="-mx-4 -mt-4 sm:-mx-6 sm:-mt-6 md:-mx-8 md:-mt-8 p-4 sm:p-6 md:p-8 min-h-screen bg-[#ffd554] pb-24 space-y-5.5 font-sans relative overflow-hidden">
    ...
    <div class="relative overflow-hidden bg-slate-900 border border-slate-800 rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 shadow-md flex items-center justify-between min-h-[130px] sm:min-h-[145px] md:min-h-[165px] relative z-10 font-['Outfit'] text-white no-print">
        <!-- Text Left Section -->
        <div class="text-left space-y-2 relative z-10 pr-28 sm:pr-44 md:pr-56">
            <div class="space-y-0.5">
                <h1 class="text-xl sm:text-2xl md:text-3xl font-black text-white tracking-tight leading-tight">Laporan Keuangan Global</h1>
            </div>

            <!-- Role Badge (Compact Size) -->
            <div class="flex flex-wrap items-center gap-1.5 sm:gap-2">
                <div class="inline-flex items-center space-x-1 px-2 py-0.5 sm:px-3 sm:py-1 bg-[#ffd554] text-slate-950 rounded-full text-[9px] sm:text-[11px] font-black shadow-xs">
        ...
        <div class="absolute -right-2 sm:-right-4 top-1/2 -translate-y-1/2 w-36 h-36 sm:w-52 sm:h-52 md:w-64 md:h-64 pointer-events-none z-0">
            <img src="/assets/headerguru.png" alt="Report Illustration" class="w-full h-full object-contain object-right-center">
        </div>
    </div>
