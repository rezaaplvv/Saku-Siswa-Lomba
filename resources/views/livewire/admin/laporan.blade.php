<div class="-mx-4 -mt-4 sm:-mx-6 sm:-mt-6 md:-mx-8 md:-mt-8 p-4 sm:p-6 md:p-8 min-h-screen bg-[#ffd554] pb-24 space-y-5.5 font-sans relative overflow-hidden">
    ...
    <div class="relative overflow-hidden bg-slate-900 border border-slate-800 rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 shadow-md flex items-center justify-between min-h-[120px] sm:min-h-[140px] md:min-h-[160px] relative z-10 font-['Outfit'] text-white no-print">
        <!-- Text Left Section -->
        <div class="text-left space-y-2 sm:space-y-3 relative z-10 pr-24 sm:pr-36 md:pr-60">
            <div class="space-y-0.5 sm:space-y-1">
                <h1 class="text-lg sm:text-2xl md:text-3xl font-black text-white tracking-tight">
                    <span class="sm:hidden">Laporan Keuangan</span>
                    <span class="hidden sm:inline">Laporan Keuangan Global</span>
                </h1>
            </div>
        ...
        <div class="absolute -right-3 -bottom-3 sm:-right-4 sm:-bottom-4 w-32 h-28 sm:w-48 sm:h-36 md:w-64 md:h-48 pointer-events-none z-0">
            <img src="/assets/headerguru.png" alt="Report Illustration" class="w-full h-full object-contain object-right-bottom">
        </div>
    </div>
