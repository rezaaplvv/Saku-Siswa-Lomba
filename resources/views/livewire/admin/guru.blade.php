    ...
    <div class="relative flex items-center justify-between min-h-[140px] z-10 font-['Outfit'] pt-4 pb-2">
        ...
        <div class="text-left space-y-3.5 relative z-10 pr-32 sm:pr-48 md:pr-64">
            <div class="space-y-1.5">
                <h1 class="text-2xl md:text-3xl font-black text-[#0f172a] tracking-tight">Manajemen Guru</h1>
                <p class="hidden md:block text-xs md:text-sm text-slate-750 font-bold leading-relaxed max-w-md">Daftar guru terdaftar dan penugasan sekolah</p>
            </div>
        </div>
