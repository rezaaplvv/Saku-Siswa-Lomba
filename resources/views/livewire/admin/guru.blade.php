<div class="-mx-4 -mt-4 sm:-mx-6 sm:-mt-6 md:-mx-8 md:-mt-8 p-4 sm:p-6 md:p-8 min-h-screen bg-[#ffd554] pb-24 space-y-6 font-sans relative overflow-hidden" x-data="{ 
    ...
    <div class="relative overflow-hidden bg-slate-900 border border-slate-800 rounded-3xl p-5 sm:p-6 shadow-md flex items-center justify-between min-h-[140px] sm:min-h-[160px] relative z-10 font-['Outfit'] text-white">
        ...
        <div class="text-left space-y-2.5 sm:space-y-3 relative z-10 pr-28 sm:pr-44 md:pr-60">
            <div class="space-y-1">
                <h1 class="text-xl sm:text-2xl md:text-3xl font-black text-white tracking-tight">Manajemen Guru</h1>
                <p class="hidden sm:block text-xs md:text-sm text-slate-300 font-medium leading-relaxed max-w-md">Daftar guru terdaftar dan penugasan sekolah</p>
            </div>
